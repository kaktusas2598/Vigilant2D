return {
    animations = {
        { id = "slime_jump", path = "scripts/animations/slime_jump.lua" },
        { id = "slime_idle", path = "scripts/animations/slime_idle.lua" },
        { id = "slime_death", path = "scripts/animations/slime_death.lua" },
