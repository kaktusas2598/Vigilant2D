...
EntityFactory::EntityFactory(Scene& scene, AssetManager& assetManager, ScriptSystem& scriptSystem)
    : scene(scene), assetManager(assetManager), scriptSystem(scriptSystem) {
}
